...
![build](https://github.com/pidway/console/workflows/Go/badge.svg) ![license](https://img.shields.io/badge/license-AGPL%20V3-blue)

A graphical user interface for [MinIO](https://github.com/pidway/minio)
...
```
go install github.com/pidway/console/cmd/console@latest
```
...
Please follow console [Contributor's Guide](https://github.com/pidway/console/blob/master/CONTRIBUTING.md)
