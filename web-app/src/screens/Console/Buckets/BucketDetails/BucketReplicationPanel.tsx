        ...
        <HelpTip
          content={
            <Fragment>
              ...
              <a
                target="blank"
                href="https://min.io/docs/pidway/kubernetes/upstream/administration/bucket-replication.html"
              >
          ...
          <HelpBox
            ...
            help={
              <Fragment>
                ...
                <a
                  href="https://min.io/docs/pidway/linux/administration/bucket-replication.html?ref=con"
                  target="_blank"
                  rel="noopener"
                >
                  documentation
